...
def main():
    ...
    input_folder = '/media/alan/work/CNN/CAFFE_VDSR/nature_dataset'
    save_folder = '/media/alan/SteinsGate/dataset/nature_sub'
    n_thread = 20
    crop_sz = 128
    step = 64
    thres_sz = 48
...
def worker(path, save_folder, crop_sz, step, thres_sz, compression_level):
    ...
    for x in h_space:
        for y in w_space:
            ...
            cv2.imwrite(
                os.path.join(save_folder, img_name.replace('.jpg', '_s{:03d}.jpg'.format(index))),
