...
# configurations
img_folder = '/media/alan/Passport2T/ESRGAN_data/patches/LR_patch/*'  # glob matching pattern
lmdb_save_path = '/media/alan/Passport2T/ESRGAN_data/patches/LR_dataset.lmdb'  # must end with .lmdb
