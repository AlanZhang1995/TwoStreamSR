...
apt-get update
apt-get -qq install git wget python-pip unzip
# install Caffe dependencies
apt-get -qq install libprotobuf-dev libleveldb-dev libsnappy-dev libhdf5-serial-dev protobuf-compiler libatlas-base-dev
apt-get -qq install libgflags-dev libgoogle-glog-dev liblmdb-dev
...
if [ ! -d "opencv-$version" ]; then
    ...
    apt-get -qq install python3-sklearn
...
apt-get install -y python-numpy python-scipy python-matplotlib python-sklearn python-skimage
